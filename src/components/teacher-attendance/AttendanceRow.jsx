...
function AttendanceRow({ student, status, onChange, presentLabel = 'Present', absentLabel = 'Absent' }) {
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-soft transition hover:border-brand/20">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={[
              ...
              isPresent
                ? 'bg-success text-white shadow-[0_12px_24px_rgba(34,197,94,0.22)]'
                : 'border border-slate-200 bg-white text-slate-700 hover:border-success/30 hover:text-success',
            ].join(' ')}
          >
          ...
          <button
            ...
            className={[
              'inline-flex items-center gap-2 rounded-2xl px-4 py-2 text-sm font-semibold transition',
              isAbsent
                ? 'bg-error text-white shadow-[0_12px_24px_rgba(239,68,68,0.22)]'
                : 'border border-slate-200 bg-white text-slate-700 hover:border-error/30 hover:text-error',
            ].join(' ')}
          >
            <X className="h-4 w-4" />
            {absentLabel}
