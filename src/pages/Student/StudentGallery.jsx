              ...
              <button
                ...
                className={[
                  ...
                  selectedYear === year
                    ...
                    : 'bg-white text-slate-600 border-slate-200 hover:border-brand/25 hover:bg-slate-50',
                ].join(' ')}
              >
                {year}
              </button>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {filteredEventsForYear.map((event) => (
                <button
                  ...
                  className="w-full text-left group overflow-hidden rounded-3xl border border-slate-200 bg-white p-5 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:border-brand/20 hover:shadow-md"
                >
          ...
          <div className="w-full max-w-4xl rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-[0_24px_80px_rgba(15,23,42,0.18)] flex flex-col max-h-[90vh]">
            ...
            <div className="flex items-start justify-between gap-3 border-b border-slate-100 pb-4">
              <div>
                ...
                <h2 className="mt-1 text-2xl font-bold text-slate-900 truncate max-w-[20rem] sm:max-w-160">
                    ...
                    <div className="grid gap-3 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
                      {normalPhotos.map((photo) => (
                        <div
                           ...
                           className="group relative aspect-square overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 cursor-pointer shadow-sm hover:border-brand/30 transition-all"
                        >
                          <img
                            src={photo.link}
                            alt="Event snapshot"
                  ...
                  {allPhotosLink ? (
                    <div className="border-t border-slate-100 pt-4 text-center">
                      <a
                        ...
                        className="inline-flex items-center gap-2 rounded-2xl bg-blue-50 px-5 py-3 text-sm font-semibold text-brand hover:bg-blue-100 transition"
                      >
